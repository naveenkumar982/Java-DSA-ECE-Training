...
Deadlock Explanation: Deadlock occurs when each thread is holding a resource and waiting for the other
thread to release it.
When deadlock occurs, it will not destroy the app, it will freeze permanently
✅how to resolve deadlock -> write a better code
 */
