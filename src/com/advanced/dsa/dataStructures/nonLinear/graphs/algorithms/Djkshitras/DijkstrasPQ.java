package com.advanced.dsa.dataStructures.nonLinear.graphs.algorithms.Djkshitras;

import java.util.*;

public class DijkstrasPQ {//Queue,PQ,Set
    public static List<Integer> dijkstras(int V, List<List<Pair>> adj, int S) {
        ...
        // Ife we get ba better distance - update -> Relaxation
        while (!pq.isEmpty()) {
    ...
    static void main(String[] args) {
        ...
        List<Integer> shortestDistanceArray = dijkstras(V,adj,S);
